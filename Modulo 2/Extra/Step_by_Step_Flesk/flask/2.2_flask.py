...
# Passar a variável através do url_for dentro do script
# html: ("{{url_for('saudacao', nome='Vasco')}}")
# 'saudacao' é o nome da função Python que define a rota.
# nome='Vasco' está passando o valor para a variável que a rota espera (<nome>)
